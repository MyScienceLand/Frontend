  ...
  return (
    <section className="bg-white h-[100vh] gap-12 grid grid-cols-2 ">
      <div className=" max-w-screen-sm w-full mx-auto gap-6 py-20">
        <img src={PurpleLogoWithText} className="pb-6" />
        ...
        <form className="  " onSubmit={formik.handleSubmit}>
          ...
          <button
            className="text-[#fff] text-[14px] border border-transparent font-normal hover:border hover:border-primary hover:bg-transparent hover:text-[#303033] bg-[--secondary-color] py-2 w-full"
            type="submit"
          >
            Login
          </button>
